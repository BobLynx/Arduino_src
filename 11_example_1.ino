...
#define _DIST_MIN 250.0   // minimum distance to be measured (unit: mm)
#define _DIST_MAX 290.0   // maximum distance to be measured (unit: mm)
...
//    dist_raw = 0;
    ...
    myservo.writeMicroseconds(float((_TARGET_HIGH - _TARGET_LOW))/(_TARGET_HIGH - dist_ema)*(_DUTY_MAX - _DUTY_NEU));
  }
