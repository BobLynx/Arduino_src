...
#define _EMA_ALPHA 0.75    // EMA weight of new sample (range: 0 to 1)
                          // Setting EMA to 1 effectively disables EMA filter.

// Servo adjustment - Set _DUTY_MAX, _NEU, _MIN with your own numbers
#define _DUTY_MAX 2340 // 2000
#define _DUTY_NEU 1600 // 1500
#define _DUTY_MIN 600 // 1000

#define _SERVO_ANGLE_DIFF  164  // Replace with |D - E| degree
#define _SERVO_SPEED       300  // servo speed

#define _BANGBANG_RANGE    450  // duty up and down for bangbang control
...
float volt_to_distance(int a_value)
{
  ...
  return 745 + -2.52*a_value + 2.14E-03*a_value*a_value;
}
